...
public class Filme {
	...
	public void cadastrar() {
		...
		do {
			...
			if (this.id != -1) {
				...
				System.err.println("Filme j� cadastrado. Cadastre outro!");
			}
	...
	public static void alterarPorId(int id) {
		...
		if (atual != null) {
			...
			if (LTPUtils.recebeSouN("GENERO: " + atual.genero + "\nAtualizar (S/N)? ") == 'S') {
				novo.genero = LTPUtils.getStringUpperCase("Digite o g�nero para atualziar: ");
			} else {
	...
	public static void excluirPorId(int id) {
		try {
			...
			if (pointer != -1) {
				...
				System.out.println("ID (" + id + "): exclu�do com sucesso!");
	...
	public void pesquisarPorNome(String nome) {
		...
		if (nome.equals(this.nome)) {
			...
			System.err.println("Filme " + nome + " N�o Entrado!");
		}
	}
	...
	public void pesquisarPorGenero(String genero) {
		...
		if (naoEncontrouGenero) {
			System.err.println("Erro: Genero não encontrado");
		}
	}
	...
	private static String validarAno(String ano) {
		do {
			...
			if (!isNumeric(ano) || ano.length() != 4 || Integer.valueOf(ano) < 1900 || Integer.valueOf(ano) > 2019) {
				System.err.println("Ano inv�lido digite um ano v�lido.");
				break;
			}
	...
	private void mostrarDadosFilme() {
		...
		System.out.println("Valor Loca��o   : " + LTPUtils.formatacaoReal(this.valorLocacao));
	}
